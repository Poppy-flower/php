                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <?php foreach ($fruit as $v){?>
                                    <tr class="" value="<?php echo $v->fruit_id;?>">
                                        <td><?php echo $v->fruit_id;?></td>
                                        <td><?php echo $v->name;?></td>
                                        <td><?php echo $v->price;?></td>
                                        <td><?php echo $v->kind;?></td>
                                        <td><a class="edit" href="javascript:;"><i class="icon-edit"></i></a></td>
                                        <td>
                                            <form action="management/send_fruit" method="post" enctype="multipart/form-data" class="change">
                                                <input type="file" name="blog-img">
                                                <input type="hidden" value="<?php echo $v->fruit_id?>" name="fruit_id">
...
<script src="assets/js/fruit_management.js"></script>
